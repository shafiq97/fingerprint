      ...
      if (authenticated) {
        ...
        setState(() {
          ...
          if (authenticationAttempts >= 3) {
            // If failed 3 times, navigate to another page
            Navigator.of(context)
                .push(MaterialPageRoute(builder: (context) => EnterCodePage()));

            authenticationAttempts = 0; // Reset attempts after navigating away
          }
        });
      }
    }
