...
import 'package:fingerprint/payment.dart';
...
class NfcPage extends StatefulWidget {
  ...
  NfcPage({required this.username});
  @override
...
class NfcPageState extends State<NfcPage> {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
        appBar: AppBar(title: Text('Tap your NFC card')),
        body: SafeArea(
  ...
  void _tagRead() {
    NfcManager.instance.startSession(onDiscovered: (NfcTag tag) async {
      ...
      _navigateToPaymentPage(); // Call this method after a successful read
    });
  }
